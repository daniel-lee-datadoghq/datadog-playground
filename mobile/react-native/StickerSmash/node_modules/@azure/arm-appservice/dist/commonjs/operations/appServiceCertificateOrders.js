...
exports.AppServiceCertificateOrdersImpl = void 0;
...
class AppServiceCertificateOrdersImpl {
    ...
    listCertificatesPagingPage(resourceGroupName, certificateOrderName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listCertificatesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listCertificates(resourceGroupName, certificateOrderName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listCertificatesNext(resourceGroupName, certificateOrderName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listCertificatesPagingAll(resourceGroupName, certificateOrderName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listCertificatesPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listCertificatesPagingPage(resourceGroupName, certificateOrderName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, certificateOrderName, certificateDistinguishedName, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, certificateOrderName, certificateDistinguishedName, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, certificateOrderName, certificateDistinguishedName, options);
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateCertificate(resourceGroupName, certificateOrderName, name, keyVaultCertificate, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateCertificateAndWait(resourceGroupName, certificateOrderName, name, keyVaultCertificate, options) {
        const poller = await this.beginCreateOrUpdateCertificate(resourceGroupName, certificateOrderName, name, keyVaultCertificate, options);
        return poller.pollUntilDone();
    }
    /**
...
exports.AppServiceCertificateOrdersImpl = AppServiceCertificateOrdersImpl;
