...
class WorkflowTriggerHistoriesImpl {
    ...
    listPagingPage(resourceGroupName, name, workflowName, triggerName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield tslib_1.__await(this._list(resourceGroupName, name, workflowName, triggerName, options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listNext(resourceGroupName, name, workflowName, triggerName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listPagingAll(resourceGroupName, name, workflowName, triggerName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listPagingPage(resourceGroupName, name, workflowName, triggerName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    _list(resourceGroupName, name, workflowName, triggerName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, name, workflowName, triggerName, options }, listOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginResubmit(resourceGroupName, name, workflowName, triggerName, historyName, options) {
     ...
     * @param options The options parameters.
     */
    async beginResubmitAndWait(resourceGroupName, name, workflowName, triggerName, historyName, options) {
        const poller = await this.beginResubmit(resourceGroupName, name, workflowName, triggerName, historyName, options);
    ...
    _listNext(resourceGroupName, name, workflowName, triggerName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, name, workflowName, triggerName, nextLink, options }, listNextOperationSpec);
    }
}
