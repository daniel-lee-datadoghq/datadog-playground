...
class WebAppsImpl {
    ...
    listBackupsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listBackupsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listBackups(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listBackupsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listBackupsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listBackupsPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listBackupsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listBasicPublishingCredentialsPoliciesPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listBasicPublishingCredentialsPoliciesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listBasicPublishingCredentialsPolicies(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listBasicPublishingCredentialsPoliciesNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listBasicPublishingCredentialsPoliciesPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listBasicPublishingCredentialsPoliciesPagingAll_1() {
            var _a, e_4, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listBasicPublishingCredentialsPoliciesPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listConfigurationsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listConfigurationsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listConfigurations(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listConfigurationsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listConfigurationsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listConfigurationsPagingAll_1() {
            var _a, e_5, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listConfigurationsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getAppSettingsKeyVaultReferencesPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getAppSettingsKeyVaultReferencesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getAppSettingsKeyVaultReferences(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getAppSettingsKeyVaultReferencesNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getAppSettingsKeyVaultReferencesPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getAppSettingsKeyVaultReferencesPagingAll_1() {
            var _a, e_6, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getAppSettingsKeyVaultReferencesPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getSiteConnectionStringKeyVaultReferencesPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getSiteConnectionStringKeyVaultReferencesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getSiteConnectionStringKeyVaultReferences(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getSiteConnectionStringKeyVaultReferencesNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getSiteConnectionStringKeyVaultReferencesPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getSiteConnectionStringKeyVaultReferencesPagingAll_1() {
            var _a, e_7, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getSiteConnectionStringKeyVaultReferencesPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listConfigurationSnapshotInfoPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listConfigurationSnapshotInfoPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listConfigurationSnapshotInfo(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listConfigurationSnapshotInfoNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listConfigurationSnapshotInfoPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listConfigurationSnapshotInfoPagingAll_1() {
            var _a, e_8, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listConfigurationSnapshotInfoPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listContinuousWebJobsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listContinuousWebJobsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listContinuousWebJobs(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listContinuousWebJobsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listContinuousWebJobsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listContinuousWebJobsPagingAll_1() {
            var _a, e_9, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listContinuousWebJobsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listProductionSiteDeploymentStatusesPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProductionSiteDeploymentStatusesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listProductionSiteDeploymentStatuses(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listProductionSiteDeploymentStatusesNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listProductionSiteDeploymentStatusesPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProductionSiteDeploymentStatusesPagingAll_1() {
            var _a, e_10, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listProductionSiteDeploymentStatusesPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listDeploymentsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDeploymentsPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listDeployments(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listDeploymentsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listDeploymentsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDeploymentsPagingAll_1() {
            var _a, e_11, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listDeploymentsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listDomainOwnershipIdentifiersPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDomainOwnershipIdentifiersPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listDomainOwnershipIdentifiers(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listDomainOwnershipIdentifiersNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listDomainOwnershipIdentifiersPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDomainOwnershipIdentifiersPagingAll_1() {
            var _a, e_12, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listDomainOwnershipIdentifiersPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listFunctionsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listFunctionsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listFunctions(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listFunctionsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listFunctionsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listFunctionsPagingAll_1() {
            var _a, e_13, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listFunctionsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listHostNameBindingsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listHostNameBindingsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listHostNameBindings(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listHostNameBindingsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listHostNameBindingsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listHostNameBindingsPagingAll_1() {
            var _a, e_14, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listHostNameBindingsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceIdentifiersPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceIdentifiersPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceIdentifiers(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceIdentifiersNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceIdentifiersPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceIdentifiersPagingAll_1() {
            var _a, e_15, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceIdentifiersPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceProcessesPagingPage(resourceGroupName, name, instanceId, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcesses(resourceGroupName, name, instanceId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessesNext(resourceGroupName, name, instanceId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceProcessesPagingAll(resourceGroupName, name, instanceId, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessesPagingAll_1() {
            var _a, e_16, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceProcessesPagingPage(resourceGroupName, name, instanceId, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceProcessModulesPagingPage(resourceGroupName, name, processId, instanceId, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessModulesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessModules(resourceGroupName, name, processId, instanceId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessModulesNext(resourceGroupName, name, processId, instanceId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceProcessModulesPagingAll(resourceGroupName, name, processId, instanceId, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessModulesPagingAll_1() {
            var _a, e_17, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceProcessModulesPagingPage(resourceGroupName, name, processId, instanceId, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceProcessThreadsPagingPage(resourceGroupName, name, processId, instanceId, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessThreadsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessThreads(resourceGroupName, name, processId, instanceId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessThreadsNext(resourceGroupName, name, processId, instanceId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceProcessThreadsPagingAll(resourceGroupName, name, processId, instanceId, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessThreadsPagingAll_1() {
            var _a, e_18, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceProcessThreadsPagingPage(resourceGroupName, name, processId, instanceId, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSiteBackupsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteBackupsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSiteBackups(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSiteBackupsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSiteBackupsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteBackupsPagingAll_1() {
            var _a, e_19, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSiteBackupsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listPerfMonCountersPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPerfMonCountersPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listPerfMonCounters(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listPerfMonCountersNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listPerfMonCountersPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPerfMonCountersPagingAll_1() {
            var _a, e_20, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listPerfMonCountersPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getPrivateEndpointConnectionListPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getPrivateEndpointConnectionListPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getPrivateEndpointConnectionList(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getPrivateEndpointConnectionListNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getPrivateEndpointConnectionListPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getPrivateEndpointConnectionListPagingAll_1() {
            var _a, e_21, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getPrivateEndpointConnectionListPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listProcessesPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listProcesses(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listProcessesNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listProcessesPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessesPagingAll_1() {
            var _a, e_22, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listProcessesPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listProcessModulesPagingPage(resourceGroupName, name, processId, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessModulesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listProcessModules(resourceGroupName, name, processId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listProcessModulesNext(resourceGroupName, name, processId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listProcessModulesPagingAll(resourceGroupName, name, processId, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessModulesPagingAll_1() {
            var _a, e_23, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listProcessModulesPagingPage(resourceGroupName, name, processId, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listProcessThreadsPagingPage(resourceGroupName, name, processId, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessThreadsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listProcessThreads(resourceGroupName, name, processId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listProcessThreadsNext(resourceGroupName, name, processId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listProcessThreadsPagingAll(resourceGroupName, name, processId, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessThreadsPagingAll_1() {
            var _a, e_24, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listProcessThreadsPagingPage(resourceGroupName, name, processId, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listPublicCertificatesPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPublicCertificatesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listPublicCertificates(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listPublicCertificatesNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listPublicCertificatesPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPublicCertificatesPagingAll_1() {
            var _a, e_25, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listPublicCertificatesPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSiteContainersPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteContainersPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSiteContainers(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSiteContainersNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSiteContainersPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteContainersPagingAll_1() {
            var _a, e_26, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSiteContainersPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSiteExtensionsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteExtensionsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSiteExtensions(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSiteExtensionsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSiteExtensionsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteExtensionsPagingAll_1() {
            var _a, e_27, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSiteExtensionsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSlotsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSlotsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSlots(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSlotsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSlotsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSlotsPagingAll_1() {
            var _a, e_28, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSlotsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listBackupsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listBackupsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listBackupsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listBackupsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listBackupsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listBackupsSlotPagingAll_1() {
            var _a, e_29, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listBackupsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listBasicPublishingCredentialsPoliciesSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listBasicPublishingCredentialsPoliciesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listBasicPublishingCredentialsPoliciesSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listBasicPublishingCredentialsPoliciesSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listBasicPublishingCredentialsPoliciesSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listBasicPublishingCredentialsPoliciesSlotPagingAll_1() {
            var _a, e_30, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listBasicPublishingCredentialsPoliciesSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listConfigurationsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listConfigurationsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listConfigurationsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listConfigurationsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listConfigurationsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listConfigurationsSlotPagingAll_1() {
            var _a, e_31, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listConfigurationsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getAppSettingsKeyVaultReferencesSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getAppSettingsKeyVaultReferencesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getAppSettingsKeyVaultReferencesSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getAppSettingsKeyVaultReferencesSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getAppSettingsKeyVaultReferencesSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getAppSettingsKeyVaultReferencesSlotPagingAll_1() {
            var _a, e_32, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getAppSettingsKeyVaultReferencesSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getSiteConnectionStringKeyVaultReferencesSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getSiteConnectionStringKeyVaultReferencesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getSiteConnectionStringKeyVaultReferencesSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getSiteConnectionStringKeyVaultReferencesSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getSiteConnectionStringKeyVaultReferencesSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getSiteConnectionStringKeyVaultReferencesSlotPagingAll_1() {
            var _a, e_33, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getSiteConnectionStringKeyVaultReferencesSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listConfigurationSnapshotInfoSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listConfigurationSnapshotInfoSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listConfigurationSnapshotInfoSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listConfigurationSnapshotInfoSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listConfigurationSnapshotInfoSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listConfigurationSnapshotInfoSlotPagingAll_1() {
            var _a, e_34, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listConfigurationSnapshotInfoSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listContinuousWebJobsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listContinuousWebJobsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listContinuousWebJobsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listContinuousWebJobsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listContinuousWebJobsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listContinuousWebJobsSlotPagingAll_1() {
            var _a, e_35, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listContinuousWebJobsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSlotSiteDeploymentStatusesSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSlotSiteDeploymentStatusesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSlotSiteDeploymentStatusesSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSlotSiteDeploymentStatusesSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSlotSiteDeploymentStatusesSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSlotSiteDeploymentStatusesSlotPagingAll_1() {
            var _a, e_36, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSlotSiteDeploymentStatusesSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listDeploymentsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDeploymentsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listDeploymentsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listDeploymentsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listDeploymentsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDeploymentsSlotPagingAll_1() {
            var _a, e_37, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listDeploymentsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listDomainOwnershipIdentifiersSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDomainOwnershipIdentifiersSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listDomainOwnershipIdentifiersSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listDomainOwnershipIdentifiersSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listDomainOwnershipIdentifiersSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDomainOwnershipIdentifiersSlotPagingAll_1() {
            var _a, e_38, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listDomainOwnershipIdentifiersSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceFunctionsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceFunctionsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceFunctionsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceFunctionsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceFunctionsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceFunctionsSlotPagingAll_1() {
            var _a, e_39, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceFunctionsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listHostNameBindingsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listHostNameBindingsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listHostNameBindingsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listHostNameBindingsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listHostNameBindingsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listHostNameBindingsSlotPagingAll_1() {
            var _a, e_40, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listHostNameBindingsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceIdentifiersSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceIdentifiersSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceIdentifiersSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceIdentifiersSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceIdentifiersSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceIdentifiersSlotPagingAll_1() {
            var _a, e_41, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceIdentifiersSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceProcessesSlotPagingPage(resourceGroupName, name, slot, instanceId, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessesSlot(resourceGroupName, name, slot, instanceId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessesSlotNext(resourceGroupName, name, slot, instanceId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceProcessesSlotPagingAll(resourceGroupName, name, slot, instanceId, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessesSlotPagingAll_1() {
            var _a, e_42, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceProcessesSlotPagingPage(resourceGroupName, name, slot, instanceId, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceProcessModulesSlotPagingPage(resourceGroupName, name, processId, slot, instanceId, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessModulesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessModulesSlot(resourceGroupName, name, processId, slot, instanceId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessModulesSlotNext(resourceGroupName, name, processId, slot, instanceId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceProcessModulesSlotPagingAll(resourceGroupName, name, processId, slot, instanceId, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessModulesSlotPagingAll_1() {
            var _a, e_43, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceProcessModulesSlotPagingPage(resourceGroupName, name, processId, slot, instanceId, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceProcessThreadsSlotPagingPage(resourceGroupName, name, processId, slot, instanceId, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessThreadsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessThreadsSlot(resourceGroupName, name, processId, slot, instanceId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceProcessThreadsSlotNext(resourceGroupName, name, processId, slot, instanceId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceProcessThreadsSlotPagingAll(resourceGroupName, name, processId, slot, instanceId, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceProcessThreadsSlotPagingAll_1() {
            var _a, e_44, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceProcessThreadsSlotPagingPage(resourceGroupName, name, processId, slot, instanceId, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSiteBackupsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteBackupsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSiteBackupsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSiteBackupsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSiteBackupsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteBackupsSlotPagingAll_1() {
            var _a, e_45, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSiteBackupsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listPerfMonCountersSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPerfMonCountersSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listPerfMonCountersSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listPerfMonCountersSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listPerfMonCountersSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPerfMonCountersSlotPagingAll_1() {
            var _a, e_46, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listPerfMonCountersSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getPrivateEndpointConnectionListSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getPrivateEndpointConnectionListSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getPrivateEndpointConnectionListSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getPrivateEndpointConnectionListSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getPrivateEndpointConnectionListSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getPrivateEndpointConnectionListSlotPagingAll_1() {
            var _a, e_47, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getPrivateEndpointConnectionListSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listProcessesSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listProcessesSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listProcessesSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listProcessesSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessesSlotPagingAll_1() {
            var _a, e_48, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listProcessesSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listProcessModulesSlotPagingPage(resourceGroupName, name, processId, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessModulesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listProcessModulesSlot(resourceGroupName, name, processId, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listProcessModulesSlotNext(resourceGroupName, name, processId, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listProcessModulesSlotPagingAll(resourceGroupName, name, processId, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessModulesSlotPagingAll_1() {
            var _a, e_49, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listProcessModulesSlotPagingPage(resourceGroupName, name, processId, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listProcessThreadsSlotPagingPage(resourceGroupName, name, processId, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessThreadsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listProcessThreadsSlot(resourceGroupName, name, processId, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listProcessThreadsSlotNext(resourceGroupName, name, processId, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listProcessThreadsSlotPagingAll(resourceGroupName, name, processId, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listProcessThreadsSlotPagingAll_1() {
            var _a, e_50, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listProcessThreadsSlotPagingPage(resourceGroupName, name, processId, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listPublicCertificatesSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPublicCertificatesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listPublicCertificatesSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listPublicCertificatesSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listPublicCertificatesSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPublicCertificatesSlotPagingAll_1() {
            var _a, e_51, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listPublicCertificatesSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSiteContainersSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteContainersSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSiteContainersSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSiteContainersSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSiteContainersSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteContainersSlotPagingAll_1() {
            var _a, e_52, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSiteContainersSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSiteExtensionsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteExtensionsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSiteExtensionsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSiteExtensionsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSiteExtensionsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSiteExtensionsSlotPagingAll_1() {
            var _a, e_53, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSiteExtensionsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSlotDifferencesSlotPagingPage(resourceGroupName, name, slot, slotSwapEntity, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSlotDifferencesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSlotDifferencesSlot(resourceGroupName, name, slot, slotSwapEntity, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSlotDifferencesSlotNext(resourceGroupName, name, slot, slotSwapEntity, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSlotDifferencesSlotPagingAll(resourceGroupName, name, slot, slotSwapEntity, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSlotDifferencesSlotPagingAll_1() {
            var _a, e_54, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSlotDifferencesSlotPagingPage(resourceGroupName, name, slot, slotSwapEntity, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSnapshotsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSnapshotsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSnapshotsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSnapshotsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSnapshotsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSnapshotsSlotPagingAll_1() {
            var _a, e_55, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSnapshotsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSnapshotsFromDRSecondarySlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSnapshotsFromDRSecondarySlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSnapshotsFromDRSecondarySlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSnapshotsFromDRSecondarySlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSnapshotsFromDRSecondarySlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSnapshotsFromDRSecondarySlotPagingAll_1() {
            var _a, e_56, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSnapshotsFromDRSecondarySlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listTriggeredWebJobsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listTriggeredWebJobsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listTriggeredWebJobsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listTriggeredWebJobsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listTriggeredWebJobsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listTriggeredWebJobsSlotPagingAll_1() {
            var _a, e_57, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listTriggeredWebJobsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listTriggeredWebJobHistorySlotPagingPage(resourceGroupName, name, webJobName, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listTriggeredWebJobHistorySlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listTriggeredWebJobHistorySlot(resourceGroupName, name, webJobName, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listTriggeredWebJobHistorySlotNext(resourceGroupName, name, webJobName, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listTriggeredWebJobHistorySlotPagingAll(resourceGroupName, name, webJobName, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listTriggeredWebJobHistorySlotPagingAll_1() {
            var _a, e_58, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listTriggeredWebJobHistorySlotPagingPage(resourceGroupName, name, webJobName, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listUsagesSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listUsagesSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listUsagesSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listUsagesSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listUsagesSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listUsagesSlotPagingAll_1() {
            var _a, e_59, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listUsagesSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listWebJobsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listWebJobsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listWebJobsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listWebJobsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listWebJobsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listWebJobsSlotPagingAll_1() {
            var _a, e_60, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listWebJobsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSlotDifferencesFromProductionPagingPage(resourceGroupName, name, slotSwapEntity, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSlotDifferencesFromProductionPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSlotDifferencesFromProduction(resourceGroupName, name, slotSwapEntity, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSlotDifferencesFromProductionNext(resourceGroupName, name, slotSwapEntity, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSlotDifferencesFromProductionPagingAll(resourceGroupName, name, slotSwapEntity, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSlotDifferencesFromProductionPagingAll_1() {
            var _a, e_61, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSlotDifferencesFromProductionPagingPage(resourceGroupName, name, slotSwapEntity, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSnapshotsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSnapshotsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSnapshots(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSnapshotsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSnapshotsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSnapshotsPagingAll_1() {
            var _a, e_62, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSnapshotsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listSnapshotsFromDRSecondaryPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSnapshotsFromDRSecondaryPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listSnapshotsFromDRSecondary(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listSnapshotsFromDRSecondaryNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listSnapshotsFromDRSecondaryPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listSnapshotsFromDRSecondaryPagingAll_1() {
            var _a, e_63, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listSnapshotsFromDRSecondaryPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listTriggeredWebJobsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listTriggeredWebJobsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listTriggeredWebJobs(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listTriggeredWebJobsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listTriggeredWebJobsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listTriggeredWebJobsPagingAll_1() {
            var _a, e_64, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listTriggeredWebJobsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listTriggeredWebJobHistoryPagingPage(resourceGroupName, name, webJobName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listTriggeredWebJobHistoryPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listTriggeredWebJobHistory(resourceGroupName, name, webJobName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listTriggeredWebJobHistoryNext(resourceGroupName, name, webJobName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listTriggeredWebJobHistoryPagingAll(resourceGroupName, name, webJobName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listTriggeredWebJobHistoryPagingAll_1() {
            var _a, e_65, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listTriggeredWebJobHistoryPagingPage(resourceGroupName, name, webJobName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listUsagesPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listUsagesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listUsages(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listUsagesNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listUsagesPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listUsagesPagingAll_1() {
            var _a, e_66, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listUsagesPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listWebJobsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listWebJobsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listWebJobs(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listWebJobsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listWebJobsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listWebJobsPagingAll_1() {
            var _a, e_67, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listWebJobsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listInstanceWorkflowsSlotPagingPage(resourceGroupName, name, slot, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceWorkflowsSlotPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listInstanceWorkflowsSlot(resourceGroupName, name, slot, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listInstanceWorkflowsSlotNext(resourceGroupName, name, slot, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listInstanceWorkflowsSlotPagingAll(resourceGroupName, name, slot, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listInstanceWorkflowsSlotPagingAll_1() {
            var _a, e_68, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listInstanceWorkflowsSlotPagingPage(resourceGroupName, name, slot, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    listWorkflowsPagingPage(resourceGroupName, name, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listWorkflowsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listWorkflows(resourceGroupName, name, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listWorkflowsNext(resourceGroupName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listWorkflowsPagingAll(resourceGroupName, name, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listWorkflowsPagingAll_1() {
            var _a, e_69, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listWorkflowsPagingPage(resourceGroupName, name, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, name, siteEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, name, siteEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginRestore(resourceGroupName, name, backupId, request, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestoreAndWait(resourceGroupName, name, backupId, request, options) {
     ...
     * @param options The options parameters.
     */
    async beginListPublishingCredentials(resourceGroupName, name, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginListPublishingCredentialsAndWait(resourceGroupName, name, options) {
     ...
     * @param options The options parameters.
     */
    async beginGetProductionSiteDeploymentStatus(resourceGroupName, name, deploymentStatusId, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginGetProductionSiteDeploymentStatusAndWait(resourceGroupName, name, deploymentStatusId, options) {
        const poller = await this.beginGetProductionSiteDeploymentStatus(resourceGroupName, name, deploymentStatusId, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for List deployments for an app, or a deployment slot.
     ...
     * @param options The options parameters.
     */
    async beginCreateMSDeployOperation(resourceGroupName, name, mSDeploy, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateMSDeployOperationAndWait(resourceGroupName, name, mSDeploy, options) {
        const poller = await this.beginCreateMSDeployOperation(resourceGroupName, name, mSDeploy, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateFunction(resourceGroupName, name, functionName, functionEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateFunctionAndWait(resourceGroupName, name, functionName, functionEnvelope, options) {
        const poller = await this.beginCreateFunction(resourceGroupName, name, functionName, functionEnvelope, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateInstanceMSDeployOperation(resourceGroupName, name, instanceId, mSDeploy, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateInstanceMSDeployOperationAndWait(resourceGroupName, name, instanceId, mSDeploy, options) {
        const poller = await this.beginCreateInstanceMSDeployOperation(resourceGroupName, name, instanceId, mSDeploy, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Get the MSDeploy Log for the last MSDeploy operation.
     ...
     * @param options The options parameters.
     */
    updateMachineKey(resourceGroupName, name, options) {
        return this.client.sendOperationRequest({ resourceGroupName, name, options }, updateMachineKeyOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginMigrateStorage(subscriptionName, resourceGroupName, name, migrationOptions, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginMigrateStorageAndWait(subscriptionName, resourceGroupName, name, migrationOptions, options) {
        const poller = await this.beginMigrateStorage(subscriptionName, resourceGroupName, name, migrationOptions, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginMigrateMySql(resourceGroupName, name, migrationRequestEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginMigrateMySqlAndWait(resourceGroupName, name, migrationRequestEnvelope, options) {
        const poller = await this.beginMigrateMySql(resourceGroupName, name, migrationRequestEnvelope, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginStartWebSiteNetworkTraceOperation(resourceGroupName, name, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStartWebSiteNetworkTraceOperationAndWait(resourceGroupName, name, options) {
        const poller = await this.beginStartWebSiteNetworkTraceOperation(resourceGroupName, name, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginApproveOrRejectPrivateEndpointConnection(resourceGroupName, name, privateEndpointConnectionName, privateEndpointWrapper, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginApproveOrRejectPrivateEndpointConnectionAndWait(resourceGroupName, name, privateEndpointConnectionName, privateEndpointWrapper, options) {
        const poller = await this.beginApproveOrRejectPrivateEndpointConnection(resourceGroupName, name, privateEndpointConnectionName, privateEndpointWrapper, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDeletePrivateEndpointConnection(resourceGroupName, name, privateEndpointConnectionName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeletePrivateEndpointConnectionAndWait(resourceGroupName, name, privateEndpointConnectionName, options) {
        const poller = await this.beginDeletePrivateEndpointConnection(resourceGroupName, name, privateEndpointConnectionName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginRestoreFromBackupBlob(resourceGroupName, name, request, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestoreFromBackupBlobAndWait(resourceGroupName, name, request, options) {
     ...
     * @param options The options parameters.
     */
    async beginRestoreFromDeletedApp(resourceGroupName, name, restoreRequest, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestoreFromDeletedAppAndWait(resourceGroupName, name, restoreRequest, options) {
        const poller = await this.beginRestoreFromDeletedApp(resourceGroupName, name, restoreRequest, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginRestoreSnapshot(resourceGroupName, name, restoreRequest, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestoreSnapshotAndWait(resourceGroupName, name, restoreRequest, options) {
        const poller = await this.beginRestoreSnapshot(resourceGroupName, name, restoreRequest, options);
        return poller.pollUntilDone();
    }
    /**
     * Lists all the site containers of a site, or a deployment slot.
     ...
     * @param options The options parameters.
     */
    async beginInstallSiteExtension(resourceGroupName, name, siteExtensionId, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginInstallSiteExtensionAndWait(resourceGroupName, name, siteExtensionId, options) {
        const poller = await this.beginInstallSiteExtension(resourceGroupName, name, siteExtensionId, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateSlot(resourceGroupName, name, slot, siteEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateSlotAndWait(resourceGroupName, name, slot, siteEnvelope, options) {
        const poller = await this.beginCreateOrUpdateSlot(resourceGroupName, name, slot, siteEnvelope, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Deletes a web, mobile, or API app, or one of the deployment slots.
     ...
     * @param options The options parameters.
     */
    async beginRestoreSlot(resourceGroupName, name, backupId, slot, request, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestoreSlotAndWait(resourceGroupName, name, backupId, slot, request, options) {
        const poller = await this.beginRestoreSlot(resourceGroupName, name, backupId, slot, request, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Returns whether Scm basic auth is allowed and whether Ftp is allowed for a given
     ...
     * @param options The options parameters.
     */
    async beginListPublishingCredentialsSlot(resourceGroupName, name, slot, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginListPublishingCredentialsSlotAndWait(resourceGroupName, name, slot, options) {
        const poller = await this.beginListPublishingCredentialsSlot(resourceGroupName, name, slot, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Updates the Push settings associated with web app.
     ...
     * @param options The options parameters.
     */
    async beginGetSlotSiteDeploymentStatusSlot(resourceGroupName, name, slot, deploymentStatusId, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginGetSlotSiteDeploymentStatusSlotAndWait(resourceGroupName, name, slot, deploymentStatusId, options) {
        const poller = await this.beginGetSlotSiteDeploymentStatusSlot(resourceGroupName, name, slot, deploymentStatusId, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for List deployments for an app, or a deployment slot.
     ...
     * @param options The options parameters.
     */
    async beginCreateMSDeployOperationSlot(resourceGroupName, name, slot, mSDeploy, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateMSDeployOperationSlotAndWait(resourceGroupName, name, slot, mSDeploy, options) {
        const poller = await this.beginCreateMSDeployOperationSlot(resourceGroupName, name, slot, mSDeploy, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Get the MSDeploy Log for the last MSDeploy operation.
     ...
     * @param options The options parameters.
     */
    async beginCreateInstanceFunctionSlot(resourceGroupName, name, functionName, slot, functionEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateInstanceFunctionSlotAndWait(resourceGroupName, name, functionName, slot, functionEnvelope, options) {
        const poller = await this.beginCreateInstanceFunctionSlot(resourceGroupName, name, functionName, slot, functionEnvelope, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Delete a function for web site, or a deployment slot.
     ...
     * @param options The options parameters.
     */
    async beginCreateInstanceMSDeployOperationSlot(resourceGroupName, name, slot, instanceId, mSDeploy, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateInstanceMSDeployOperationSlotAndWait(resourceGroupName, name, slot, instanceId, mSDeploy, options) {
        const poller = await this.beginCreateInstanceMSDeployOperationSlot(resourceGroupName, name, slot, instanceId, mSDeploy, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Get the MSDeploy Log for the last MSDeploy operation.
     ...
     * @param options The options parameters.
     */
    async beginStartWebSiteNetworkTraceOperationSlot(resourceGroupName, name, slot, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStartWebSiteNetworkTraceOperationSlotAndWait(resourceGroupName, name, slot, options) {
        const poller = await this.beginStartWebSiteNetworkTraceOperationSlot(resourceGroupName, name, slot, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Stop ongoing capturing network packets for the site.
     ...
     * @param options The options parameters.
     */
    async beginApproveOrRejectPrivateEndpointConnectionSlot(resourceGroupName, name, privateEndpointConnectionName, slot, privateEndpointWrapper, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginApproveOrRejectPrivateEndpointConnectionSlotAndWait(resourceGroupName, name, privateEndpointConnectionName, slot, privateEndpointWrapper, options) {
        const poller = await this.beginApproveOrRejectPrivateEndpointConnectionSlot(resourceGroupName, name, privateEndpointConnectionName, slot, privateEndpointWrapper, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Deletes a private endpoint connection
     ...
     * @param options The options parameters.
     */
    async beginDeletePrivateEndpointConnectionSlot(resourceGroupName, name, privateEndpointConnectionName, slot, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeletePrivateEndpointConnectionSlotAndWait(resourceGroupName, name, privateEndpointConnectionName, slot, options) {
        const poller = await this.beginDeletePrivateEndpointConnectionSlot(resourceGroupName, name, privateEndpointConnectionName, slot, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Gets the private link resources
     ...
     * @param options The options parameters.
     */
    async beginRestoreFromBackupBlobSlot(resourceGroupName, name, slot, request, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestoreFromBackupBlobSlotAndWait(resourceGroupName, name, slot, request, options) {
        const poller = await this.beginRestoreFromBackupBlobSlot(resourceGroupName, name, slot, request, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Restores a deleted web app to this web app.
     ...
     * @param options The options parameters.
     */
    async beginRestoreFromDeletedAppSlot(resourceGroupName, name, slot, restoreRequest, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestoreFromDeletedAppSlotAndWait(resourceGroupName, name, slot, restoreRequest, options) {
        const poller = await this.beginRestoreFromDeletedAppSlot(resourceGroupName, name, slot, restoreRequest, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Restores a web app from a snapshot.
     ...
     * @param options The options parameters.
     */
    async beginRestoreSnapshotSlot(resourceGroupName, name, slot, restoreRequest, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginRestoreSnapshotSlotAndWait(resourceGroupName, name, slot, restoreRequest, options) {
        const poller = await this.beginRestoreSnapshotSlot(resourceGroupName, name, slot, restoreRequest, options);
        return poller.pollUntilDone();
    }
    /**
     * Lists all the site containers of a site, or a deployment slot.
     ...
     * @param options The options parameters.
     */
    async beginInstallSiteExtensionSlot(resourceGroupName, name, siteExtensionId, slot, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginInstallSiteExtensionSlotAndWait(resourceGroupName, name, siteExtensionId, slot, options) {
        const poller = await this.beginInstallSiteExtensionSlot(resourceGroupName, name, siteExtensionId, slot, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Remove a site extension from a web site, or a deployment slot.
     ...
     * @param options The options parameters.
     */
    async beginSwapSlot(resourceGroupName, name, slot, slotSwapEntity, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginSwapSlotAndWait(resourceGroupName, name, slot, slotSwapEntity, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateSourceControlSlot(resourceGroupName, name, slot, siteSourceControl, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateSourceControlSlotAndWait(resourceGroupName, name, slot, siteSourceControl, options) {
        const poller = await this.beginCreateOrUpdateSourceControlSlot(resourceGroupName, name, slot, siteSourceControl, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginStartNetworkTraceSlot(resourceGroupName, name, slot, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStartNetworkTraceSlotAndWait(resourceGroupName, name, slot, options) {
     ...
     * @param options The options parameters.
     */
    async beginSwapSlotWithProduction(resourceGroupName, name, slotSwapEntity, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginSwapSlotWithProductionAndWait(resourceGroupName, name, slotSwapEntity, options) {
        const poller = await this.beginSwapSlotWithProduction(resourceGroupName, name, slotSwapEntity, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Returns all Snapshots to the user.
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateSourceControl(resourceGroupName, name, siteSourceControl, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateSourceControlAndWait(resourceGroupName, name, siteSourceControl, options) {
        const poller = await this.beginCreateOrUpdateSourceControl(resourceGroupName, name, siteSourceControl, options);
        return poller.pollUntilDone();
    }
    /**
     * Description for Deletes the source control configuration of an app.
     ...
     * @param options The options parameters.
     */
    async beginStartNetworkTrace(resourceGroupName, name, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStartNetworkTraceAndWait(resourceGroupName, name, options) {
...
exports.WebAppsImpl = WebAppsImpl;
...
const updateMachineKeyOperationSpec = {
