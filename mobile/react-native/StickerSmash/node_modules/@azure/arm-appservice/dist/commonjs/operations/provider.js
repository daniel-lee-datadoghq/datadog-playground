...
class ProviderImpl {
    ...
    getAvailableStacksPagingPage(options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getAvailableStacksPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getAvailableStacks(options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getAvailableStacksNext(continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getAvailableStacksPagingAll(options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getAvailableStacksPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getAvailableStacksPagingPage(options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    getFunctionAppStacksPagingPage(options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getFunctionAppStacksPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getFunctionAppStacks(options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getFunctionAppStacksNext(continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getFunctionAppStacksPagingAll(options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getFunctionAppStacksPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getFunctionAppStacksPagingPage(options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getFunctionAppStacksForLocationPagingPage(location, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getFunctionAppStacksForLocationPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getFunctionAppStacksForLocation(location, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getFunctionAppStacksForLocationNext(location, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getFunctionAppStacksForLocationPagingAll(location, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getFunctionAppStacksForLocationPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getFunctionAppStacksForLocationPagingPage(location, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getWebAppStacksForLocationPagingPage(location, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getWebAppStacksForLocationPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getWebAppStacksForLocation(location, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getWebAppStacksForLocationNext(location, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getWebAppStacksForLocationPagingAll(location, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getWebAppStacksForLocationPagingAll_1() {
            var _a, e_4, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getWebAppStacksForLocationPagingPage(location, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getWebAppStacksPagingPage(options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getWebAppStacksPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getWebAppStacks(options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getWebAppStacksNext(continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getWebAppStacksPagingAll(options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getWebAppStacksPagingAll_1() {
            var _a, e_6, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getWebAppStacksPagingPage(options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
    ...
    getAvailableStacksOnPremPagingPage(options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* getAvailableStacksOnPremPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._getAvailableStacksOnPrem(options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._getAvailableStacksOnPremNext(continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    getAvailableStacksOnPremPagingAll(options) {
        return tslib_1.__asyncGenerator(this, arguments, function* getAvailableStacksOnPremPagingAll_1() {
            var _a, e_7, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.getAvailableStacksOnPremPagingPage(options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
