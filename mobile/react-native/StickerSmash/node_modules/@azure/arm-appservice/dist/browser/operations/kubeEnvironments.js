...
export class KubeEnvironmentsImpl {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, name, kubeEnvironmentEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, name, kubeEnvironmentEnvelope, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, name, kubeEnvironmentEnvelope, options);
