...
export class BoundedBuffer extends DatadogBuffer {
  ...
  logRandomIdGenerationError = error => {
    this.addTelemetryEvent('Could not generate enough random numbers', getErrorStackTrace(error), 'RandomIdGenerationError');
  ...
  drainTelemetry = () => {
    Object.values(this.telemetryBuffer).forEach(({
      ...
      DdSdk.telemetryError(`${message} happened ${occurrences} times.`, stack, kind);
    });
  };
}
