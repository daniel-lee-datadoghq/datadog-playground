 ...
 */
export const metroSourceMapString = (modules, options) => {
  ...
  } else if (sourceMapString && typeof sourceMapString === 'object' && typeof sourceMapString['sourceMapString'] === 'function') {
    sourceMapStringFunc = sourceMapString.sourceMapString;
  }
  if (!sourceMapStringFunc) {
