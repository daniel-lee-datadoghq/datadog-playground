...
import { convertSerializerOutput as getMetroBundleWithMap, getSortedModules, metroSourceMapString } from './utils';
...
export const createDefaultMetroSerializer = () => {
  return (entryPoint, preModules, graph, options) => {
    ...
    const map = metroSourceMapString([...preModules, ...getSortedModules(graph, options)], {
