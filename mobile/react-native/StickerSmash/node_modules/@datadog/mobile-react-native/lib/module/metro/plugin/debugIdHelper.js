 ...
 */
export const createDebugIdModule = debugId => {
 ...
 */
export const addDebugIdModule = (preModules, debugIdModule) => {
 ...
 */
export const createDebugIdSnippet = debugId => {
 ...
 */
export const getDebugIdFromBundleSource = code => {
 ...
 */
export const createDebugIdFromBundle = bundle => {
 ...
 * @returns The computed Debug ID.
 */
export const createDebugIdFromString = str => {
 ...
 */
export const injectDebugIdInCode = (code, debugId) => {
 ...
 */
export const injectDebugIdInCodeAndSourceMap = (debugId, code, sourcemap) => {
...
const writeDebugIdToFile = debugId => {
  try {
    ...
    const datadogTmpDir = path.join(path.dirname(datadogPackageJsonPath), '.tmp');
 ...
 */
export const _isDebugIdInBundle = (debugId, bundleCode) => {
 ...
 */
export const checkIfDebugIdModuleExists = modules => modules.findIndex(module => module.path === DEBUG_ID_MODULE_PATH) !== -1;

/**
 * [INTERNAL] Replaces the existing Debug ID comment in the bundle with a new one, containing the given Debug ID.
 */
export const _replaceDebugIdInBundle = (debugId, bundleCode) => {
 ...
 */
export const _insertDebugIdCommentInBundle = (debugId, bundleCode) => {
