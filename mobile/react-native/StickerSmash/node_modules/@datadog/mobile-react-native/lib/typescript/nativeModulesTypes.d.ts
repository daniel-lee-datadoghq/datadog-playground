...
export declare class DdNativeSdkConfiguration {
    ...
    constructor(clientToken: string, env: string, applicationId: string, nativeCrashReportEnabled: boolean, sampleRate: number, site: string, trackingConsent: string, additionalConfiguration: object);
}
/**
...
type ResourceKind = 'image' | 'xhr' | 'beacon' | 'css' | 'document' | 'fetch' | 'font' | 'js' | 'media' | 'other' | 'native';
...
export interface DdNativeRumType extends NativeDdRum {
     ...
     */
    addError(message: string, source: ErrorSource, stacktrace: string, context: object, timestampMs: number, fingerprint: string | undefined): Promise<void>;
}
export {};
