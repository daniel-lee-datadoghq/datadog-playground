...
exports.formatFirstPartyHosts = exports.buildConfigurationFromPartialConfiguration = exports.addDefaultValuesToAutoInstrumentationConfiguration = exports.VitalsUpdateFrequency = exports.UploadFrequency = exports.InitializationMode = exports.DdSdkReactNativeConfiguration = exports.DatadogProviderConfiguration = exports.DEFAULTS = exports.BatchSize = exports.BatchProcessingLevel = void 0;
 ...
 */
let VitalsUpdateFrequency = exports.VitalsUpdateFrequency = /*#__PURE__*/function (VitalsUpdateFrequency) {
...
let UploadFrequency = exports.UploadFrequency = /*#__PURE__*/function (UploadFrequency) {
  /**
...
let BatchSize = exports.BatchSize = /*#__PURE__*/function (BatchSize) {
  /**
...
let BatchProcessingLevel = exports.BatchProcessingLevel = /*#__PURE__*/function (BatchProcessingLevel) {
  /**
...
const formatFirstPartyHosts = firstPartyHosts => {
  return firstPartyHosts.map(host => {
    if (isLegacyFirstPartyHost(host)) {
      return {
        match: host,
        propagatorTypes: [_types.PropagatorType.DATADOG, _types.PropagatorType.TRACECONTEXT]
      };
    }
    return host;
  });
...
let InitializationMode = exports.InitializationMode = /*#__PURE__*/function (InitializationMode) {
