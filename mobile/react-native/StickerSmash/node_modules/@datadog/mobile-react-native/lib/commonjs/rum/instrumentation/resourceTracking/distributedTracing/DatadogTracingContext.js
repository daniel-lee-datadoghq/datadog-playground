...
exports.DatadogTracingContext = void 0;
var _DatadogTracingIdentifier = require("./DatadogTracingIdentifier");
/*
...
class DatadogTracingContext {
  constructor(requestHeaders, resourceContext, traceId, spanId) {
    ...
    this.traceId = traceId ? new _DatadogTracingIdentifier.DatadogTracingIdentifier(traceId) : undefined;
    this.spanId = spanId ? new _DatadogTracingIdentifier.DatadogTracingIdentifier(spanId) : undefined;
  }
...
exports.DatadogTracingContext = DatadogTracingContext;
