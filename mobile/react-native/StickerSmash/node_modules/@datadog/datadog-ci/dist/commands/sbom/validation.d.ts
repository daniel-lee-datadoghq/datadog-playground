 ...
 * @param dependencies
 */
export declare const filterInvalidDependencies: (dependencies: Dependency[]) => Dependency[];
export declare const validateDependencyName: (dependency: Dependency) => boolean;
